...
class InputManager:
    def __init__(self) -> None:
        ...
        # --- Added: Used to store the text input content for this frame ---
    ...
    def reset(self) -> None:
        ...
        self.mouse_wheel = 0
        # --- Added: Reset text input every frame ---
        self._text_input = ""
    ...
    def handle_events(self, e: pg.event.Event) -> None:
        ...
        # --- Core Modification: Handling Text Input Events ---
        elif e.type == pg.TEXTINPUT:
            # Capture and accumulate all text input in this frame (Shift, capitalization, and input method have been handled)
    ...
    # --- Scroll ---
    def mouse_scrolled(self) -> bool:
        return self.mouse_wheel != 0
    
    def mouse_scrolled_up(self) -> bool:
        return self.mouse_wheel == 1
    
    def mouse_scrolled_down(self) -> bool:
        return self.mouse_wheel == -1
    
    # --- Added Method: For KeyInTextBar to call ---
    def get_text_input(self) -> str:
        """Get the text content input in the current frame"""
